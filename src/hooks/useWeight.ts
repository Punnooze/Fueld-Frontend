...
import { getWeight, getLatestWeight, getWeightJourney, createWeight, deleteWeight, type WeightPayload } from '../api/weight'
...
export const useWeightJourney = () =>
  useQuery({ queryKey: ['weight', 'journey'], queryFn: getWeightJourney })
